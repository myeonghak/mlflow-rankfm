...
class RankFM_MLflow(mlflow.pyfunc.PythonModel):
    ...
    def predict(self,context, model_input):
        result=self.recommend(model_input.values[0])
        recommendations=item_names[item_names.item_id.isin(result.values[0])].set_index('item_id')
